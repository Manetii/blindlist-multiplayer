...
ok('console porte les trois sections', ['s-dupes','s-collect','s-files','s-options','s-play'].every(id=>hct.includes(id)));
ok('panneau joueurs permanent', hct.includes('class="col-people"')&&hct.includes('console-layout'));
ok('code et QR dans le panneau', /col-people[\s\S]*id="c-code"[\s\S]*id="c-qr"/.test(hct));
