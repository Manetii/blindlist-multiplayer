...
ok('compteur d attente unique', ph.includes('id="kpi-wait"')&&ph.includes('id="kpi-wait-label"')&&!ph.includes('id="kpi-ready"'));
ok('compteur de progression harmonise', ph.includes('id="kpi-progress"'));
